...
impl RecieveApiFrame for AtCommandReponse {
    fn id(&self) -> FrameId{
...
impl TransmitApiFrame for AtCommandFrame<'_> {
    ...
    fn gen(&self) -> Result<BytesMut> {
        ...
        packet.put_u8(DELIM);
        packet.put_u8(0); // length 0 just a placeholder
        packet.put_u8(frame_id);
